...
public class Client_Dt {
    int client_id,fam_id,c_height,c_weight;
    String c_name,c_mail,c_address,c_city,c_user,c_pass,c_bg,c_gender,c_dob,c_phone;
    ...
    public String getC_bg() {
        return c_bg;
    }

    public void setC_bg(String c_bg) {
        this.c_bg = c_bg;
    }
