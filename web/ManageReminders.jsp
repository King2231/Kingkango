...
<hr><hr>
<div class="plaintext">Time and Tide waits for no man !!!<br><a href="AddReminder.jsp"><span class="glyphicon glyphicon-time">Set Reminders</span></a> on Kingkango avoiding missing important moments.</div>

<hr><hr>
<div class="plaintext">Want to Update a Reminder<br><a href="ShowReminders.jsp"><span class="glyphicon glyphicon-download">Right Here</span></a> It's Easy.</div>
