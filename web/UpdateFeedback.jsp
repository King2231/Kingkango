<%-- 
    ...
    Created on : 15-Mar-2016, 00:27:45
    Author     : King
--%>
...
<%
        ...
        Feedback_Dt fbd=Feedback_Worker.showfeedbackById(fid);

%>
<div class="contentcp">
     <div class="clientcontent">
        <form action="UpdateFeedback_Action.jsp" method="post">
          <div class="form-group">     
              <input type="hidden" name="feedback_id" value="<%=fbd.getFeedback_id()%>">
          <label for="comment">Feedback:</label>
          <textarea class="form-control" rows="5" id="comment" name="Feedback"><%=fbd.getFeedback()%></textarea>
          <center><input type="submit" name="action" value="Done"></center>
          <br>
          </div>
         </form>
     </div>
