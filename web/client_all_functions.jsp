...
<div id="sidebar">
 <ul>
    <li><a href="#" title="Home"><img src="home.png" class="img-cirlce" width="100" height="100"></a></li>
    <li><a href="#" title="Blog"><img src="blog.png" class="img-circle" width="100" height="100"></a></li>
    <li><a href="Show_ClientProfile.jsp" title="Profile"><img src="update2.png" class="img-circle" width="100" height="100"></a></li>
...
<hr><hr>
<div id="links">
    <div id="img1"><a href="ManageFamily.jsp"><img src="img/fanager.png" class="btn-lg" height="300" width="350"></a></div>
    <div id="img2"><a href="ManageReports.jsp"><img src="img/Ranager.png" class="btn-lg" height="300" width="350"></a></div>   
</div>
<hr><hr>
<div id="links2">
    <div id="img1"><a href="AddReminder.jsp"><img src="img/Timer.png" class="btn-lg" height="300" width="350"></a></div>
    <div id="img2"><a href="AddGuider.jsp"><img src="img/Picture1.png" class="btn-lg" height="300" width="350"></a></div>
</div>
<hr><hr>
</div>
