 ...
 <ul>
    ...
    <div class="content1" >        
        <div class="clientcontent">
            ...
            <% for(FamilyMember_Dt md:list) {%>
            <tr align="center">
                <td><a href="ShowFamilyMem_id.jsp?id=<%=md.getMem_id()%>"><%= md.getM_name()%></a></td>
                <td><%=md.getM_dob()%></td>
                <td><%=md.getM_bgroup()%></td>
                <td><%=md.getM_height()%></td>
                <td><%=md.getM_weight()%></td>
                <td><%=md.getM_gender()%></td>     
            </tr>
            ...
            <a href="AddFamilyMember.jsp" class="btn-group-lg"><span class="glyphicon glyphicon-plus-sign">Add Members</span></a>
        </div>
    </div>
            <script>
