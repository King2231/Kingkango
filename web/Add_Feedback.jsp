<%-- 
    ...
    Created on : 14-Mar-2016, 12:04:38
    Author     : King
--%>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <title>Kingkango :Feedback</title>
    <style>
...
<div id="sidebar">
 <ul>
    ...
    <li><a href="#" title="Feedback"><img src="blog.png" class="img-circle" width="100" height="100"></a></li>
...
<div class="contentcp">
        ...
        <%
            ArrayList <Feedback_Dt> list=Feedback_Worker.getAllFeedback();
    %>   
   
    <div class="feedback">
      <hr><hr><hr>
      <center>What People Say About Us:</center><hr>
      <div class="feedbackcontent">
       <%for(Feedback_Dt fd:list){%>
       <%=fd.getFeedback()%>
       <%if(fd.getFeedback_c_id()==cd.getClient_id()){%>
       <br><a href="UpdateFeedback.jsp?id=<%=fd.getFeedback_id()%>" title="edit"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a href="deleteFeedback.jsp?id=<%=fd.getFeedback_id()%>" title="remove"><span class="glyphicon glyphicon-remove"></span></a>
          <%}%>
       <hr><br>
          <%}%>
    ...
    <div class="clientcontent">
        <form action="AddFeedback_Action.jsp" method="post">
          <div class="form-group">     
              <input type="hidden" name="client_id" value="<%=cd.getClient_id()%>">
